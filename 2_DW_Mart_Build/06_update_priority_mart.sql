...
-- Show updated data from priority_roles_table
SELECT '=== Updated Priority Roles Dimension Table ===' AS info;
...
SELECT '=== Verify Updated Mart Summary ===' AS info;
SELECT 'Priority Roles Dimension Table' AS table_name, COUNT(*) as record_count FROM priority_mart.priority_roles
UNION ALL
SELECT 'Priority Jobs Snapshot Table', COUNT(*) FROM priority_mart.priority_jobs_snapshot;


-- Show updated data from priority_jobs_snapshot table
SELECT '=== Updated Priority Jobs Snapshot Table ===' AS info;
SELECT
    job_title_short,
    COUNT(*) AS job_count,
